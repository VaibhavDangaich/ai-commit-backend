...
app.post('/generate', async (req, res) => {
    ...
    try {
        ...
        const prompt = `Generate a concise Git commit message based on the following staged diff:\n\n${diff},give a concise primary then give little more detailed commit message below it so that when i click on the message icon under commits on my repo in github it shows detailed commit too,dont display the prompt i am asking you to do just output the commit message, don't use backtiks in the commit message`;
